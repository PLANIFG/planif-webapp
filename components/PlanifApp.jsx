...
// écran le temps de la conversion, puis retiré. Cette fonction n'est JAMAIS
// appelée pendant le rendu — uniquement à l'intérieur d'un gestionnaire de
// clic (onClick), donc jamais côté serveur ni pendant l'hydratation.
